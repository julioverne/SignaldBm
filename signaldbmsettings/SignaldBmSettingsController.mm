...
@interface SignaldBmSettingsController : PSListController
{
	UILabel* _label;
	UILabel* underLabel;
}
...
@implementation SignaldBmSettingsController
- (id)specifiers {
	if (!_specifiers) {
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"WiFi dBm"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"rssi_wifi" forKey:@"key"];
		[spec setProperty:@YES forKey:@"PromptRespring"];
		[spec setProperty:@YES forKey:@"default"];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Cell dBm"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"rssi_cell" forKey:@"key"];
		[spec setProperty:@YES forKey:@"PromptRespring"];
		[spec setProperty:@YES forKey:@"default"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#SignaldBm by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)HeaderCell
{
	@autoreleasepool {
		...
		[underLabel setText:@"Replece Signal Bars with dBm level"];
